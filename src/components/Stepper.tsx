...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full rounded-4xl shadow-xl border border-gray-200 ${stepCircleContainerClassName}`}
      >
            ...
            return (
              <React.Fragment key={stepNumber}>
                {renderStepIndicator ? (
                  ...
                  <StepIndicator
                    step={stepNumber}
                    disableStepIndicators={disableStepIndicators || stepNumber === totalSteps}
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'var(--color-blue-600)', color: 'var(--color-blue-600)' },
          complete: { scale: 1, backgroundColor: 'var(--color-blue-600)', color: 'var(--color-blue-600)' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--color-blue-600)' }
  };
