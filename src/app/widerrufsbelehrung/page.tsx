          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-neutral-600 leading-relaxed">
                ...
                15566 Schöneiche bei Berlin, Telefon: 01749342676, E-Mail: hartmann-schaerfservice@web.de) mittels einer 
            ...
            <section className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="text-neutral-600 space-y-2">
                ...
                <p>Telefon: <a href="tel:+491749342676" className="text-blue-600 hover:text-blue-700 hover:underline">01749342676</a></p>
              </div>
            </section>
          </div>
        </div>
